...
public class GameLogicTest {
    ...
    public static void main(String[] args) {
        System.out.println("========== 牌类游戏助手 - 逻辑测试 ==========");
        System.out.println();
    ...
    private static void testFortyCard() {
        System.out.println("【40张宝子测试】");
        FortyCardRule rule = new FortyCardRule();
        List&lt;PlayerHand&gt; hands = generateRandomHands(rule, 7);
        ...
        System.out.println("结果: " + result.getDisplayText());
        System.out.println("播报: " + result.getSpeechText());
    }

    private static void testJinHua() {
        System.out.println("【金花测试】");
        JinHuaRule rule = new JinHuaRule();
        List&lt;PlayerHand&gt; hands = generateRandomHands(rule, 7);
        GameAnalyzer.AnalysisResult result = GameAnalyzer.analyze(hands);
    ...
    private static void testDouNiu() {
        System.out.println("【斗牛测试】");
        DouNiuRule rule = new DouNiuRule();
        List&lt;PlayerHand&gt; hands = generateRandomHands(rule, 7);
        GameAnalyzer.AnalysisResult result = GameAnalyzer.analyze(hands);
